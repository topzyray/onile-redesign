...
const Service = ({ imageUrl, title, text }) => {
    ...
    return <>
        <section ref={ref} className={`flex flex-col content-center gap-3 rounded-t-xl w-[19rem] sm:w-[23.125rem] lg:w-[19rem] xl:w-[23.125rem] h-[26rem] sm:h-[28.9375rem] lg:h-[26rem] xl:h-[28.9375rem] border border-solid border-[#CECECE]   transition-opacity ease-in duration-700 ${isVisible ? "opacity-100" : "opacity-0"}`}>
            <section>
        ...
        <section className='bg-[#F3F4F5] w-full flex justify-center py-8'>
            <section className='flex flex-col gap-6'>
                ...
                <section className="grid lg:grid-cols-3 gap-4 lg:gap-6 xl:gap-10">
                    <Service imageUrl="/assets/services_property.png" title="Property Listing" text="Explore a sectionerse portfolio of meticulously curated properties, from contemporary condos to sprawling estates." />
