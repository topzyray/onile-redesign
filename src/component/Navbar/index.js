...
const Navbar = () => {
  ...
  return (
    <nav className='fixed w-full h-[6rem] sm:h-[8rem] shadow-lg bg-[#1D2939] text-[#F2F4F7]'>
      ...
      <div className={
        menuOpen 
        ? "fixed right-0 top-0 w-[65%] sm:hidden h-screen bg-[#2a3648] pl-14 pr-5 py-8 ease-in duration-500"
        ...
        <div onClick={handleNav} className='sm:hidden cursor-pointer flex justify-end'>
          <AiOutlineClose className='hover:bg-[#1D2939] hover:rounded-lg p-1' size={40} />
        </div>

        <div className='flex flex-col w-full items-start justify-center'>
          <div className='flex-col py-4'>
            <ul className='text-xl font-bold'>
              <Link href="/" className='hover:underline hover:font-bold focus:text-[#FF7F50] focus:font-bold'><li onClick={() => setMenuOpen(false)} className='py-4 cursor-pointer'>Home</li></Link>
              <Link href="/properties" className='hover:underline hover:font-bold focus:text-[#FF7F50] focus:font-bold'><li onClick={() => setMenuOpen(false)} className='py-4 cursor-pointer'>Properties</li></Link>
              <Link href="/services" className='hover:underline hover:font-bold focus:text-[#FF7F50] focus:font-bold'><li onClick={() => setMenuOpen(false)} className='py-4 cursor-pointer'>Services</li></Link>
              <Link href="/contact" className='hover:underline hover:font-bold focus:text-[#FF7F50] focus:font-bold'><li onClick={() => setMenuOpen(false)} className='py-4 cursor-pointer'>Contact</li></Link>
            </ul>
          </div>
        </div>

        <div className='flex-col items-center py-4 mb-4'>
          <Image src={avatar} alt='Profile avatar' width={30} height={30} />
          <Link href="/auth" className='font-bold hover:underline hover:font-bold focus:text-[#FF7F50] focus:font-bold'><p>Sign Up/Sign In</p></Link>
        </div>
