...
const About = () => {
    ...
    return <>
        <section className='bg-white text-[#344054] w-full flex justify-center pt-8 pb-80 lg:pb-8'>
            <section className='flex flex-col gap-6 pb-4'>
                <section className='text-center'>
                    <h1 className='text-[1.5rem] md:text-[2rem] font-bold'>About Us</h1>
                </section>
                <section className="w-[22.25rem] md:w-[32.25rem] lg:w-[62.25rem] h-[20.9375rem] grid lg:grid-cols-2 gap-4 md:gap-6 lg:gap-12">
                    <div className={`transition-opacity ease-in duration-700 ${isVisible ? "opacity-100" : "opacity-0"}`}>
                        <Image 
                            src={about} 
                            alt='About us image' 
                    ...
                    <div ref={ref} className={`flex flex-col content-start gap-4 md:gap-2 lg:w-[27.875rem] lg:px-0   transition-opacity ease-in duration-700 ${isVisible ? "opacity-100" : "opacity-0"}`}>
